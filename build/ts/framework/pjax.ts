...
export class PJAX extends Service {
    ...
    public getTransitionName(el: HTMLAnchorElement): string | null {
        ...
        let transitionAttr = el.getAttribute(
            this.getConfig("transitionAttr", false)
        );
    ...
    public validLink(
        ...
        let preventSelf = el.hasAttribute(
            this.getConfig("preventSelfAttr", false)
        );
    ...
    public go({
        ...
        return this.load({
            oldHref: currentURL.getPathname(),
            href,
            trigger,
            transitionName,
        });
    ...
    public async load({
        ...
        try {
            ...
            try {
                ...
                this.EventEmitter.emit("NAVIGATION_START", {
                    oldPage,
                    newPage,
                    trigger,
                    transitionName,
