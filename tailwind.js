...
module.exports = {
    ...
    theme: {
        ...
        //     md:
        //         "0 -1px 6px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",
        //     lg:
    ...
    variants: {
        ...
        backgroundColor: ["hover", "focus"], // , "responsive", "group-hover"
        backgroundOpacity: ["hover"], // "responsive",  , "group-hover", "focus"
        backgroundPosition: [],
        backgroundRepeat: [],
        backgroundSize: [],
        borderCollapse: [], // "responsive"
        borderColor: ["hover", "focus"], // "responsive", "group-hover",
        borderOpacity: [],
        borderRadius: [],
        borderStyle: [],
        borderWidth: [],
        ...
        textOpacity: ["hover", "group-hover"], // "responsive", , "focus"
        textDecoration: ["hover", "group-hover"], // "responsive", , "focus"
        textTransform: [],
        userSelect: [],
